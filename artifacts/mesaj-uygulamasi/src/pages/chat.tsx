      ...
      <header className="px-3 py-3 sticky top-0 z-10 bg-card/90 backdrop-blur-md border-b border-border flex items-center gap-3">
        ...
        {convLoading ? (
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div>
              <p className="font-semibold text-sm leading-tight" data-testid="text-other-user-name">
                {otherUser?.name}
              </p>
              <p className="text-xs text-muted-foreground leading-tight" data-testid="text-user-status">
                {statusLabel}
              </p>
            </div>
          </div>
      ...
      <main className="flex-1 overflow-y-auto px-4 py-4 space-y-2">
        {msgsLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground py-16">
            ...
            <p className="text-xs mt-1">Merhaba demekle basla!</p>
          </div>
        ) : (
          <>
            {messages.map((msg, i) => {
